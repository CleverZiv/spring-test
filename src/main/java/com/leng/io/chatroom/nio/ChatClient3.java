...
public class ChatClient3 {
    private static final Logger logger = LoggerFactory.getLogger(ChatClient3.class);
    ...
    private void handles(SelectionKey key) throws IOException {
        ...
        if(key.isConnectable()) {
            ...
            if(client.isConnectionPending()) {
                ...
                // 处理用户输入的信息
                new Thread(new UserInputHandler3(this)).start();
            }
            // 注册 读 事件，监控是否有消息转发过来
    ...
    public static void main(String[] args) {
        ChatClient3 client = new ChatClient3(DEFAULT_SERVER_HOST, DEFAULT_PORT);
        client.start();
    }
}
